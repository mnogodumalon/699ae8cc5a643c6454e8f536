...
export function KurseDialog({ open, onClose, onSubmit, defaultValues, dozentenList, raeumeList, enablePhotoScan = true, enablePhotoLocation = true }: KurseDialogProps) {
