...
export function KursanmeldungViewDialog({ open, onClose, record, onEdit, kurseList }: KursanmeldungViewDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Kursanmeldung anzeigen</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{formatDate(record.fields.teilnehmer_geburtsdatum)}</p>
          </div>
          <div className="space-y-1">
