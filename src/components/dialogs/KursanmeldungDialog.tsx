...
export function KursanmeldungDialog({ open, onClose, onSubmit, defaultValues, kurseList, enablePhotoScan = true, enablePhotoLocation = true }: KursanmeldungDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'kursanmeldung');
  ...
  const DIALOG_INTENT = defaultValues ? 'Kursanmeldung bearbeiten' : 'Kursanmeldung hinzufügen';
