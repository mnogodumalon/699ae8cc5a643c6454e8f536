...
const navigation = [
  ...
  { name: 'Kursanmeldung', href: '/kursanmeldung', icon: IconBook },
...
const externalNavigation = [
  { name: 'Teilnehmer', href: '/gateway/apps/699ae8b1c9d1cbfb6fca882e?template=list_page', icon: IconUsers },
  { name: 'Kursanmeldung', href: '/gateway/apps/699ae8b2260a2e5209ebfa1f?template=list_page', icon: IconBook },
  { name: 'Räume', href: '/gateway/apps/699ae8b09300bacb8903a84c?template=list_page', icon: IconDoorEnter },
  { name: 'Kurse', href: '/gateway/apps/699ae8b18700a39d668ef868?template=list_page', icon: IconBook },
  { name: 'Dozenten', href: '/gateway/apps/699ae8aa3c91c2ef115da050?template=list_page', icon: IconSchool },
  { name: 'Anmeldungen', href: '/gateway/apps/699ae8b2ae2a43295a0c2d3a?template=list_page', icon: IconClipboardList },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/699ae8b1c9d1cbfb6fca882e?template=list_page"
