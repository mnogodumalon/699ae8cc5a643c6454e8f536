...
import { AlertCircle, ChevronLeft, ChevronRight, Plus, Users, BookOpen, GraduationCap, Euro, Calendar, MapPin, Clock, X, Check, Edit2, Trash2 } from 'lucide-react';
                ...
                {anmeldungen.map(a => (
                  <div key={a.record_id} className="flex items-center justify-between py-1.5 px-2 rounded bg-accent/50 text-sm">
                    ...
                    <Badge variant={a.fields.bezahlt ? 'default' : 'secondary'} className="text-xs">
                      {a.fields.bezahlt ? <Check size={10} className="mr-1" /> : null}
