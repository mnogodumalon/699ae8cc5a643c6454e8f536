...
const KURSANMELDUNG_FIELDS = [
  ...
  { key: 'teilnehmer_geburtsdatum', label: 'Geburtsdatum', type: 'date/date' },
...
const ENTITY_TABS = [
  ...
  { key: 'kursanmeldung', label: 'Kursanmeldung', pascal: 'Kursanmeldung' },
...
export default function AdminPage() {
  ...
  const getFieldMeta = useCallback((entity: EntityKey) => {
    switch (entity) {
      ...
      case 'kursanmeldung': return KURSANMELDUNG_FIELDS;
