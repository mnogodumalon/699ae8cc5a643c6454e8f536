...
import type { Dozenten, Raeume, Kurse, Teilnehmer, Anmeldungen, Kursanmeldung } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async createKursanmeldungEntry(fields: Kursanmeldung['fields']) {
    return callApi('POST', `/apps/${APP_IDS.KURSANMELDUNG}/records`, { fields });
  }
  static async updateKursanmeldungEntry(id: string, fields: Partial<Kursanmeldung['fields']>) {
    return callApi('PATCH', `/apps/${APP_IDS.KURSANMELDUNG}/records/${id}`, { fields });
  }
